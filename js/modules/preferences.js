...
(function() {
  ...
  // Авто-инициализация удалена — теперь модуль инициализируется через Application.init()
  // Для обратной совместимости оставляем экспорт, но не вызываем init автоматически
